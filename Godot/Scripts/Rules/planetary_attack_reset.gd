...
var _barrier_scene: PackedScene = preload("res://Scenes/Bodies/generic/barrier.tscn")
var _cannon_scene: PackedScene = preload("res://Scenes/Bodies/nonplayer/nonplayer_paddle_cannon.tscn")
